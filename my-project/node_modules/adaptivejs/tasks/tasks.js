...
module.exports = function(grunt) {
    ...
    // Load component installer/uninstaller
    grunt.loadTasks('tasks/component-installer');

    // Remove build directory contents
    grunt.registerTask('adaptive-clean_build', function() {
    ...
    //
    // Deprecated in favor of a new method of detecting whether to serve minified
    // assets or not (see adaptivejs/src/utils/isLocal.js)
    grunt.registerTask('copy_ui', function() {
        grunt.log.warn('This task is deprecated - see adaptivejs/src/utils/isLocal.js for determining whether to load minified assets.');
    ...
    // Build tasks
    grunt.registerTask('adaptive-build_dev', ['adaptive-ensure_synced', 'sync', 'requirejs:ui', 'cachebuster', 'adaptive-build_config', 'requirejs:adaptation', 'requirejs:loader']);
    grunt.registerTask('adaptive-build_prod', ['adaptive-ensure_synced', 'sync', 'requirejs:uiMin', 'cachebuster','adaptive-build_config', 'requirejs:adaptationMin', 'requirejs:loaderMin']);
    ...
    grunt.registerTask('adaptive-test_ci', ['connect:test', 'mocha_phantomjs:ci']);
    grunt.registerTask('adaptive-test', ['connect:test', 'mocha_phantomjs:local']);
