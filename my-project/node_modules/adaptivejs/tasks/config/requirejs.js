...
module.exports = function(grunt) {
    var loaderOptions = {
        ...
        paths: {
            ...
            'preload-html': '../build/preload.min.html',
            'preload-css': '../build/preload.min.css',
            'preload-js': '../build/preload.min.js',
    ...
    var adaptationOptions = {
        ...
        paths: {
            ...
            'component-handler': '../node_modules/adaptivejs/lib/component-handler'
        },
        shim: {
            'dust-core': {
                'exports': 'dust'
    ...
    var uiOptions = {
        removeCombined: true,
        name: 'ui',
        mainConfigFile: ['./app/config/ui.js'],
        baseUrl: 'app/',
    ...
    // If these two JSON files don't exist, substitute a stub.json file instead
    // The component handler will use the existence of the stub to tell other
    // Adaptive.js files if they can enable component integration or not
    adaptationOptions.paths['component-installed'] = grunt.file.isFile('app/config/system/component-installed.json') ? 'config/system/component-installed.json' : '../node_modules/adaptivejs/lib/stub.json';
    adaptationOptions.paths['component-locations'] = grunt.file.isFile('app/config/component.json') ? 'config/component.json' : '../node_modules/adaptivejs/lib/stub.json';

    // Conditionally include component ui script module loader
    if (grunt.file.isFile('app/config/system/component-ui.js')) {
        uiOptions.include = ['config/system/component-ui.js'];
    }

    // Conditionally add component ui script paths to config
    if (grunt.file.isFile('app/config/system/component-paths.js')) {
        uiOptions.mainConfigFile.push('./app/config/system/component-paths.js');
    }
