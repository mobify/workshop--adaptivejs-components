...
define(['dust-full', 'json!config/system/component-installed.json', 'json!config/component.json'], function(dust, installedComponents, componentLocations) {
    'use strict';

    if (typeof window === 'undefined') {
        // Only parse as JSON when r.js is optimizing
